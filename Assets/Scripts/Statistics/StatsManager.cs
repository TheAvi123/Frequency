...
namespace Statistics {
    public class StatsManager : MonoBehaviour
    {
        ...
        private void UpdateAverageStats() {
            ...
            averageTimeSurvived  =         totalTimeSurvived   / runsCompleted;
        }
        ...
        private TextMeshProUGUI FindStatObjectByTag(string objTag) {
            return GameObject.FindGameObjectWithTag(objTag).GetComponent<TextMeshProUGUI>();
            //If throwing NullPointerException, check if GameObject is enabled...
        }

        private TextMeshProUGUI FindStatObjectByName(string objName) {
            foreach (TextMeshProUGUI statObject in Resources.FindObjectsOfTypeAll<TextMeshProUGUI>()) {
                if (statObject.gameObject.name == objName) {
